...
|----------|-------|--------------------|---------------|
| Understanding the Importance of Time & Space Complexity | 11/18/2021  | Fibonacci Sequence | [Link](https://colab.research.google.com/github/SJUACM/Technical-Interview-Prep/blob/main/SJU_ACM_Software_Engineering_Interview_Prep_.ipynb)
...
# Time and Space Complexity
  ...
  - Knowing how to calculate the time and space complexity for an algorithm is essential if you want to land a Software Engineering role. When given a problem, it is crucial 
    ...
    ### Big-O Cheat Sheet
     ...
     <p align="center">
        <img width="1500" alt="bigOcheatsheet" src="https://user-images.githubusercontent.com/43652410/119038596-4b4a1c80-b981-11eb-9759-7b69884e6681.png">
        <img width="700" alt="sortingcheatsheet" src="https://user-images.githubusercontent.com/43652410/119176675-64160900-ba39-11eb-895a-16c05235d8cb.png">
     </p>
